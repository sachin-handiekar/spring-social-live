...
public class SocialConfig {
	...
	public ConnectionFactoryLocator connectionFactoryLocator() {
		...
		registry.addConnectionFactory(new LiveConnectionFactory(environment.getProperty("live.clientId"), environment
				.getProperty("live.clientSecret")));
		return registry;
	}
	...
	@Scope(value = "request", proxyMode = ScopedProxyMode.INTERFACES)
	public Live live() {
		return connectionRepository().getPrimaryConnection(Live.class).getApi();
	}
